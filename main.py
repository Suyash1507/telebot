...
# adding a reminder button to the bot
...
def enter_message_handler(update: Update, context: CallbackContext):
    update.message.reply_text("Please enter time when bot should remind: ")
...
if __name__ == '__main__':
    ...
    updater.dispatcher.add_handler(conv_handler)# adding a conversation handler
